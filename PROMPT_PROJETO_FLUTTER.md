...
Este documento consolida os padrões, decisões técnicas e boas práticas utilizados no projeto 
---
...
**Requisito:** Flutter 3.41.3 (ou superior compatível). Para fixar a versão com FVM:
```bash
fvm use 3.41.3
fvm flutter run
```
