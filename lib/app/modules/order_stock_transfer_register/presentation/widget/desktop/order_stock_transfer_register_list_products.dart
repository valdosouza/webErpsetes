...
class OrderStockTransferRegisterListProducts extends StatefulWidget {
  const OrderStockTransferRegisterListProducts({
    Key? key,
  }) : super(key: key);

  @override
  State<OrderStockTransferRegisterListProducts> createState() =>
      OrderStockTransferRegisterListProductsState();
}

class OrderStockTransferRegisterListProductsState
    extends State<OrderStockTransferRegisterListProducts> {
