...
class BarChartWeekSalesInfo extends StatefulWidget {
  const BarChartWeekSalesInfo({super.key});
  ...
  @override
  State<StatefulWidget> createState() => BarChartWeekSalesInfoState();
}

class BarChartWeekSalesInfoState extends State<BarChartWeekSalesInfo> {
  ...
  BarChartGroupData makeGroupData(
    ...
    Color? barColor,
    double width = 22,
    List<int> showTooltips = const [1, 5, 10],
  }) {
  ...
  Widget getBottomTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = const Text('SG', style: style);
        break;
      case 1:
        text = const Text('TE', style: style);
        break;
      case 2:
        text = const Text('QU', style: style);
        break;
      case 3:
        text = const Text('QT', style: style);
        break;
      case 4:
