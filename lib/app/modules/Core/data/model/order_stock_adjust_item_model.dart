import 'package:appweb/app/modules/Core/domain/entity/order_stock_adjust_item_entity.dart';

class OrderStockAdjustItemModel extends OrderStockAdjustItemEntity {
  OrderStockAdjustItemModel({
    int? id,
    int? tbOrderId,
    int? tbProductId,
    String? nameProduct,
  ...
  factory OrderStockAdjustItemModel.fromJson(Map<String, dynamic> json) {
    return OrderStockAdjustItemModel(
      id: json['id'],
  ...
  factory OrderStockAdjustItemModel.empty() {
    return OrderStockAdjustItemModel();
  }
}
