...
class WidgetStockListtState extends State<WidgetStockList> {
  ...
  Scaffold _stockList(OrderStockAdjustRegisterState state) {
    return Scaffold(
      appBar: AppBar(
            ...
            child: widget.stockList.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) => InkWell(
                      onTap: () {
                        bloc.orderMain.orderStockAdjust.nameStockList =
                            widget.stockList[index].description;
                        bloc.orderMain.orderStockAdjust.tbStockListId =
                            widget.stockList[index].id;
                        bloc.add(
