...
class OrderStockAdjustmentRegisterListProducts extends StatefulWidget {
  const OrderStockAdjustmentRegisterListProducts({
    Key? key,
  }) : super(key: key);

  @override
  State<OrderStockAdjustmentRegisterListProducts> createState() =>
      OrderStockAdjustmentRegisterListProductsState();
}

class OrderStockAdjustmentRegisterListProductsState
    extends State<OrderStockAdjustmentRegisterListProducts> {
                  ...
                  if (quantity == 0) {
                    ...
                    if (index == -1) {
                      bloc.orderMain.items
                          .add(OrderStockAdjustmentRegisterItemsModel(
                        id: 0,
